...
function createInstallError(error) {
  ...
  if (stderr.includes('No connected devices')) {
    ...
    message = `Looks like your Android environment is not properly set. Please go to ${_chalk().default.dim.underline(_cliTools().link.docs('set-up-your-environment', 'android', {
      hash: 'jdk-studio',
      guide: 'native'
