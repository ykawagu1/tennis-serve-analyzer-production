...
export class RewardedInterstitialAd extends MobileAd {
  ...
  static createForAdRequest(adUnitId, requestOptions) {
    ...
    return new RewardedInterstitialAd('rewarded_interstitial', requestId, adUnitId, NativeRewardedInterstitialModule.rewardedInterstitialLoad, NativeRewardedInterstitialModule.rewardedInterstitialShow, options);
  }
