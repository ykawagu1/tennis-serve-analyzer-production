...
class RewardedInterstitialAd extends _MobileAd.MobileAd {
  ...
  static createForAdRequest(adUnitId, requestOptions) {
    ...
    return new RewardedInterstitialAd('rewarded_interstitial', requestId, adUnitId, _NativeRewardedInterstitialModule.default.rewardedInterstitialLoad, _NativeRewardedInterstitialModule.default.rewardedInterstitialShow, options);
  }
